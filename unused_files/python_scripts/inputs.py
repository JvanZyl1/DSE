...
bat_vol_dens = 450  # volumetric energy density of the battery in [Wh/L]
...
h = 1.
V_cr = 100 / 3.6  # Cruise velocity [m/s]
N_prop_big = 10  # Number of propellers [-]
R_prop_big = 0.9  # m
N_prop_small = 2  # Number of propellers [-]
R_prop_small = 0.52  # m
A_disk = R_prop_big**2 * np.pi * N_prop_big + R_prop_small**2 * np.pi * N_prop_small
B_prop = 2  # Number of blades per propeller [-]
c_prop = 0.3
alpha_TPP = 5 * np.pi / 180
...
N_nac = 3
kg_per_m_beam = 4.5  # kg/m
beam_lengths = [0.6, 0.6, 1., 1., 1., 1., 2., 2.]
...
# Motor inputs
torque_cont = 32  # Nm, for EMRAX 268 motor, https://emrax.com/wp-content/uploads/2017/10/user_manual_for_emrax_motors.pdf
torque_thrust = 90
av_power = 20000
max_power = 60000  # W
