...
boom_2_01 = Boom(cs_2.R * np.cos(2 * pi * 0.121), cs_2.R * np.sin(2 * pi * 0.121), 10e-6, 0.0006)
boom_2_02 = Boom(cs_2.R * np.cos(2 * pi * 0.250), cs_2.R * np.sin(2 * pi * 0.250), 10e-6, 0.0006)
boom_2_03 = Boom(cs_2.R * np.cos(2 * pi * 0.379), cs_2.R * np.sin(2 * pi * 0.379), 10e-6, 0.0006)
boom_2_04 = Boom(cs_2.R * np.cos(2 * pi * 0.596), cs_2.R * np.sin(2 * pi * 0.596), 10e-6, 0.0006)
boom_2_05 = Boom(cs_2.R * np.cos(2 * pi * 0.641), cs_2.R * np.sin(2 * pi * 0.641), 10e-6, 0.0006)
boom_2_06 = Boom(cs_2.R * np.cos(2 * pi * 0.750), cs_2.R * np.sin(2 * pi * 0.750), 10e-6, 0.0006)
boom_2_07 = Boom(cs_2.R * np.cos(2 * pi * 0.859), cs_2.R * np.sin(2 * pi * 0.859), 10e-6, 0.0006)
boom_2_08 = Boom(cs_2.R * np.cos(2 * pi * 0.904), cs_2.R * np.sin(2 * pi * 0.904), 10e-6, 0.0006)
...
boom_3_03 = Boom(cs_3.R * np.cos(2 * pi * 0.596), cs_3.R * np.sin(2 * pi * 0.596), 40e-6, 0.000)
boom_3_04 = Boom(cs_3.R * np.cos(2 * pi * 0.641), cs_3.R * np.sin(2 * pi * 0.641), 40e-6, 0.0006)
boom_3_05 = Boom(cs_3.R * np.cos(2 * pi * 0.710), cs_3.R * np.sin(2 * pi * 0.710), 50e-6, 0.0006)
boom_3_06 = Boom(cs_3.R * np.cos(2 * pi * 0.790), cs_3.R * np.sin(2 * pi * 0.790), 50e-6, 0.0006)
boom_3_07 = Boom(cs_3.R * np.cos(2 * pi * 0.859), cs_3.R * np.sin(2 * pi * 0.859), 40e-6, 0.000)
boom_3_08 = Boom(cs_3.R * np.cos(2 * pi * 0.904), cs_3.R * np.sin(2 * pi * 0.904), 40e-6, 0.000)

# Define booms  ## Cross-section 4
boom_4_01 = Boom(cs_4.R * 1.05 * np.cos(2 * pi * 0.122), cs_4.R * 1.05 * np.sin(2 * pi * 0.122), 50e-6, 0.000)
boom_4_02 = Boom(cs_4.R * 1.05 * np.cos(2 * pi * 0.152), cs_4.R * 1.05 * np.sin(2 * pi * 0.152), 25e-6, 0.0015)
boom_4_03 = Boom(cs_4.R * np.cos(2 * pi * 0.250), cs_4.R * np.sin(2 * pi * 0.250), 20e-6, 0.0015)
...
boom_4_07 = Boom(cs_4.R * 1.05 * np.cos(2 * pi * 0.641), cs_4.R * 1.05 * np.sin(2 * pi * 0.641), 40e-6, 0.001)
boom_4_08 = Boom(cs_4.R * np.cos(2 * pi * 0.710), cs_4.R * np.sin(2 * pi * 0.710), 10e-6, 0.001)
boom_4_09 = Boom(cs_4.R * np.cos(2 * pi * 0.790), cs_4.R * np.sin(2 * pi * 0.790), 10e-6, 0.001)
boom_4_10 = Boom(cs_4.R * 1.05 * np.cos(2 * pi * 0.859), cs_4.R * 1.05 * np.sin(2 * pi * 0.859), 40e-6, 0.000)
boom_4_11 = Boom(cs_4.R * 1.05 * np.cos(2 * pi * 0.883), cs_4.R * 1.05 * np.sin(2 * pi * 0.883), 100e-6, 0.000)

# Define booms  ## Cross-section 5
boom_5_01 = Boom(cs_5.R * np.cos(2 * pi * 0.022), cs_5.R * np.sin(2 * pi * 0.022), 10e-6, 0.001)
boom_5_02 = Boom(cs_5.R * np.cos(2 * pi * 0.125), cs_5.R * np.sin(2 * pi * 0.125), 25e-6, 0.001)
boom_5_03 = Boom(cs_5.R * np.cos(2 * pi * 0.250), cs_5.R * np.sin(2 * pi * 0.250), 15e-6, 0.001)
boom_5_04 = Boom(cs_5.R * np.cos(2 * pi * 0.375), cs_5.R * np.sin(2 * pi * 0.375), 25e-6, 0.001)
boom_5_05 = Boom(cs_5.R * np.cos(2 * pi * 0.478), cs_5.R * np.sin(2 * pi * 0.478), 10e-6, 0.000)
boom_5_06 = Boom(cs_5.R * np.cos(2 * pi * 0.637), cs_5.R * np.sin(2 * pi * 0.637), 30e-6, 0.001)
boom_5_07 = Boom(cs_5.R * np.cos(2 * pi * 0.710), cs_5.R * np.sin(2 * pi * 0.710), 20e-6, 0.001)
boom_5_08 = Boom(cs_5.R * np.cos(2 * pi * 0.790), cs_5.R * np.sin(2 * pi * 0.790), 20e-6, 0.001)
...
cs_4.plot_booms()
cs_4.plot_skin()
plt.savefig("CrossSection_4.png")
cs = cs_6
