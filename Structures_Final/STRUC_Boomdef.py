...
boom_1_04 = Boom(cs_1.R * np.cos(2 * pi * 0.4), cs_1.R * np.sin(2 * pi * 0.4), 0.003, 0.0015)
boom_1_05 = Boom(cs_1.R * np.cos(2 * pi * 0.5), cs_1.R * np.sin(2 * pi * 0.5), 0.0005, 0.000)
boom_1_06 = Boom(cs_1.R * np.cos(2 * pi * 0.6), cs_1.R * np.sin(2 * pi * 0.6), 0.0003, 0.001)
boom_1_07 = Boom(cs_1.R * np.cos(2 * pi * 0.7), cs_1.R * np.sin(2 * pi * 0.7), 0.003, 0.001)
...
boom_3_03 = Boom(cs_1.R * np.cos(2 * pi * 0.7), cs_1.R * np.sin(2 * pi * 0.75), 0.0003, 0.001)
boom_3_04 = Boom(cs_1.R * np.cos(2 * pi * 1.0), cs_1.R * np.sin(2 * pi * 1), 0.0003, 0.0015)
