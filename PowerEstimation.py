...
def Cruise_Power_estimation_rotorcraft(R_prop, N_prop, V_cr, omega_prop, rho, g, MTOW,D_q_tot_x):
    ...
    alpha_TPP = RC_AoA(V_cr, D_q_tot_x, rho, MTOW, g) # angle of attack in cruise [deg]
