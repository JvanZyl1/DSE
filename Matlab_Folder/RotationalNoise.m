function SPL = RotationalNoise(theta,S,m,B,omega,a,T,Q,R_e,rho,N)
    ...
    function p_m_L = LoadingNoise(theta,S,m,B,omega,a,T,Q,R_e)
        ...
        J=besselj(m*B,(m*B*omega/a)*R_e*sin(theta)); %First order bessel function
