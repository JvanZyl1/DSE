...
S_pylon = l_pyl * 2*pi *R_pyl*(N_prop_big+N_prop_small); % Estimated pylon wet area [m^2]

%Own design estimated from above parameters
S_fus = pi*D^2/4 ;%Fuselage cross-sectional area [m^2]
S_disk = R_prop_big^2 * pi * N_prop_big + R_prop_small^2 * pi * N_prop_small ;%Rotor disk area [m^2]
% Parasite CDA
