...
"""
Function for the cost estimation for the initial trade-off.
All equations for the development and production costs were taken from https://www.researchgate.net/profile/Falk-Goetten/publication/337757069_Cost_Estimation_Methods_for_Hybrid-Electric_General_Aviation_Aircraft/links/5de87703299bf10bc3405695/Cost-Estimation-Methods-for-Hybrid-Electric-General-Aviation-Aircraft.pdf
"""

def total_costs(W_struct, E_total, P_TOL, R_prop):
    V_H = (1/0.51)*V_cr
    CPI = 1.27 + (1.27 / 10)*(yop - 2022)   # 1 dollar in 2012 (date of literature) is worth as much as 1.27 now, found in https://www.bls.gov/data/inflation_calculator.htm
    ...
    C_eng = 0.083 * W_struct**0.791 * V_H**1.521 * N_ps**0.183 * 1.6 * 1.66 * 92 * CPI * ex_rate                        # Engineering
    ...
    C_qc = 0.13 * C_mfg * 1.5 * 1.5 * ex_rate                                                                           # Quality control
